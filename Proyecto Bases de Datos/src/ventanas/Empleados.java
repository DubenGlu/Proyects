 ...
 FondoPanel fondo= new FondoPanel();
    ...
    private void initComponents() {
        ...
        TablaEmpleados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id_empleado", "Contraseña", "Id_persona"
            }
        ));
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txt_idempleado, javax.swing.GroupLayout.DEFAULT_SIZE, 269, Short.MAX_VALUE)
    ...
    private void btn_insertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_insertarActionPerformed
        try {
            int id_empleado = Integer.parseInt(txt_idempleado.getText().toString());
            String contraseña = txt_con.getText().toString();
            int id_persona = Integer.parseInt(txt_idpersona.getText().toString());

            Connection con = Conexion.getConexion();
            PreparedStatement ps = con.prepareStatement("INSERT INTO  EMPLEADOS (ID_EMPLEADO, CONTRASENA, ID_PERSONA) VALUES(?,?,?)");
    ...
    private void btn_actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_actualizarActionPerformed
        ...
        try {
            ...
            Connection con = Conexion.getConexion();
            PreparedStatement ps = con.prepareStatement("UPDATE EMPLEADOS SET CONTRASENA= ?, ID_PERSONA= ? WHERE ID_EMPLEADO= ?");
