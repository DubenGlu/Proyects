...
public class Cupones extends javax.swing.JFrame {
 FondoPanel fondo= new FondoPanel();
    ...
    private void initComponents() {
        ...
        txt_idcupon = new javax.swing.JTextField();
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addComponent(txt_idcupon, javax.swing.GroupLayout.DEFAULT_SIZE, 269, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel1)
                    .addComponent(txt_idcupon, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
    ...
    private void btn_insertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_insertarActionPerformed
        try {
            int id_cupon = Integer.parseInt(txt_idcupon.getText().toString());
            String concepto = txt_concepto.getText().toString();
            int monto = Integer.parseInt(txt_monto.getText().toString());

            Connection con = Conexion.getConexion();
            PreparedStatement ps = con.prepareStatement("INSERT INTO  CUPONES (ID_CUPON, CONCEPTO, MONTO) VALUES(?,?,?)");
    ...
    private void btn_actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_actualizarActionPerformed
        ...
        try {
            ...
            Connection con = Conexion.getConexion();
            PreparedStatement ps = con.prepareStatement("UPDATE CUPONES SET CONCEPTO= ?, MONTO= ? WHERE ID_CUPON= ?");

            ps.setString(1, concepto);
            ps.setInt(2, monto);
            ps.setInt(3, id_cupon);
    ...
    private void btn_eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_eliminarActionPerformed
        try {
            int id_cupon = Integer.parseInt(txt_idcupon.getText().toString());
            Connection con = Conexion.getConexion();
            PreparedStatement ps = con.prepareStatement("DELETE FROM CUPONES WHERE ID_CUPON= ?");
            ps.setInt(1, id_cupon);
            ps.executeUpdate();
    ...
    public void cargarTabla() {
        try {
            DefaultTableModel modelotabla = (DefaultTableModel) TablaCupones.getModel();
            ...
            Connection con = Conexion.getConexion();
            ps = con.prepareStatement("Select* from Cupones");
            rs = ps.executeQuery();
            rsmd = rs.getMetaData();
    ...
    private javax.swing.JTextField txt_idcupon;
