...
public class Servicios extends javax.swing.JFrame {
    ...
    public static void cargarTabla() {
                ...
                try {
                    ...
                    ResultSet result = leer.executeQuery("SELECT * FROM SERVICIOS ORDER BY ID_SERVICIO");
                    ...
                    if (datos[0] == null) {
                        JOptionPane.showMessageDialog(null, "No se ha insertado ningun servicio");
                    }else{
     ...
     public void limpiarTabla(){
        ...
        DefaultTableModel tb = (DefaultTableModel) tablaServicios.getModel();
        int a = tablaServicios.getRowCount()-1;
        int b = tablaServicios.getColumnCount()-1;
        for (int i = a; i >= 0; i--) {          
    ...
    private void btn_agregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_agregarActionPerformed
        insertar_servicios ob = new insertar_servicios();
        ob.setVisible(true);
        this.dispose();
    ...
    private void btn_eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_eliminarActionPerformed
        eliminar_servicios ob = new eliminar_servicios();
        ob.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_btn_eliminarActionPerformed

    private void btn_editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editarActionPerformed
        editar_servicios ob = new editar_servicios();
        ob.setVisible(true);
        this.dispose();
    ...
    private static javax.swing.JTable tablaServicios;
