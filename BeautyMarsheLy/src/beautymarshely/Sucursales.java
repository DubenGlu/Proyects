...
public class Sucursales extends javax.swing.JFrame {
    ...
    public static void cargarTabla() {
                ...
                try {
                    ...
                    ResultSet result = leer.executeQuery("SELECT * FROM VISTA");
                    ...
                    tablaSucursales.setModel(tabla);
                    if (datos[0] == null) {
                        JOptionPane.showMessageDialog(null, "No se ha insertado ninguna sucursal");
                    }else{
    ...
    public static void limpiarTabla(){
        ...
        DefaultTableModel tb = (DefaultTableModel) tablaSucursales.getModel();
        int a = tablaSucursales.getRowCount()-1;
        int b = tablaSucursales.getColumnCount()-1;
        for (int i = a; i >= 0; i--) {          
    ...
    private void initComponents() {
        ...
        jButton1.setText("Direcciones");
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton1ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(604, 370, -1, -1));
        ...
        tablaSucursales.setToolTipText("");
    ...
    private void btn_agregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_agregarActionPerformed
        insertar_sucursal ob_il = new insertar_sucursal();
    ...
    private void btn_eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_eliminarActionPerformed
        eliminar_sucursal ob = new eliminar_sucursal();
        ob.setVisible(true);
        this.dispose();
    ...
    private void btn_editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editarActionPerformed
        editar_sucursal ob = new editar_sucursal();
        ob.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_btn_editarActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Direcciones ob = new Direcciones();
        ob.setVisible(true);
        this.dispose();
    ...
    private static javax.swing.JTable tablaSucursales;
